...
public class StudypastFragment4 extends Fragment {
    private static final String TAG = "StudypastFragment4";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.studypast4, container, false);
        return mView;
    }
