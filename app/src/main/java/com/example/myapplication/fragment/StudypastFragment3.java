...
public class StudypastFragment3 extends Fragment {
    private static final String TAG = "StudypastFragment3";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.studypast3, container, false);
        return mView;
    }
