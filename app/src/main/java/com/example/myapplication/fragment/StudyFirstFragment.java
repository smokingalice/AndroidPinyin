...
import com.example.myapplication.NEWViewPager;
...
public class StudyFirstFragment extends Fragment {
    ...
    private List<String> mPageList = new ArrayList<String>(); // 标题文字列表
    private NEWViewPager vp_content;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ClassPagerAdapter adapter = new ClassPagerAdapter(mActivity, mPageList);
